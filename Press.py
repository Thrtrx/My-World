#Open Source By DARK TEAM LMNx9 
# cheak line 220 # cheak line 123
"""

REVERSE DONE BY LMNx9 
...
os.system("espeak -a 300 \"UPDATE VERSION 1.0 V,\"")
time.sleep(2)
#os.system('clear')
...
time.sleep(2)
os.system(f'xdg-open https://youtube.com/LMNx9')
...
alltimexudi =(""" \033[32;1m[-] ONLY APPROVAL SYSTEM 7 DAYS 200TK 30 500TK FOR    APPROVAL""")
...
def menu():
    ...
    if ASHIK in ['111']:
        ...
        os.system('xdg-open https://github.com/LMNx9-JOHNY')
        os.system("python nono.py")
    elif ASHIK in ['3','03']:
        result()
    elif ASHIK in ['0']:
...
def passwrd():
   ...
   # print("\033[1;91m[\033[1;92m√\033[1;91m] \033[41m\x1b[1;97m𝚂𝚃𝙰𝚁𝚃𝙴𝙳 𝚈𝙾𝚄𝚁 𝙲𝙻𝙾𝙽𝙸𝙽𝙶 𝚃𝙸𝙼𝙴\033[0;97m :> \x1b[38;5;50m"+time.strftime("%H:%M")+" "+ tag)
    ...
    os.system("python LIMON-PAID.py")
    exit()
